# MobiRides Commercialization Plan Updates
**Date:** 23 November 2025  
**Status:** Based on Actual Performance Data (Jan-Nov 2025)

## ACTUAL PERFORMANCE DATA (Jan-Nov 2025)

### Current Status:
- **Platform:** Web app MVP operational since Q1 2025
- **User Base:** 154 registered users (zero paid marketing) | ⚠️ 95% have NOT completed new 3-step verification (conversion blocker)
- **Fleet:** 56 vehicles | ⚠️ 80%+ from Trillo Rentals (ONLY signed MOU - HIGH concentration risk)
- **Revenue:** P247,535+ generated (Jan-Oct 2025), 305% growth rate
- **Active Campaign:** Nov 17-Dec 14, 2025 (P100 OFF, code FIRST100)
- **Funding:** P700K pre-seed round **TARGET CLOSE: Dec 15, 2025** (3 weeks - CRITICAL)
- **IP Protection:** ✓ Trademark approved by CIPA, international registration in progress

### Confirmed Partnerships:
- **Insurance:** BIC, Pay-U (operational) ✓
- **Financing:** Sekele Fund, Metshelo (Rent2Buy discussions - targeting Dec 15 close)
- **Mobile Money:** Orange, Mascom, BeMobile ✓
- **Ecosystem:** BDIH, BoostUp Accelerator, Deverse Labs ✓
- **Fleet:** Trillo Rentals (ONLY signed MOU - 80%+ inventory) ⚠️ HIGH RISK - need diversification
...
- **Next Round:** P700K pre-seed (P200K Rent2Buy fund, P500K operations)
  - **CRITICAL DEADLINE:** December 15, 2025 (3 weeks from now)
  - **Current Runway:** 13 months at P5.4K/month burn rate
  - **Status:** Investor documentation due Dec 15th, terminal date set

---

## CRITICAL RISK UPDATE (Nov 24, 2025)

### 🔴 IMMEDIATE ACTION REQUIRED

**1. Fleet Partner Concentration Risk - CRITICAL**
- **Status:** 80%+ of inventory from Trillo Rentals (ONLY provider with signed MOU)
- **Impact:** Platform vulnerable to single partner withdrawal; revenue concentration risk
- **Action:** Sign MOUs with 3-5 additional fleet partners by Q1 2026; target <40% concentration per partner
- **Timeline:** Urgent - Q1 2026
- **Responsible:** CEO + Partnerships Lead

**2. Pre-Seed Funding Deadline - CRITICAL**
- **Deadline:** December 15, 2025 (3 weeks from now)
- **Amount:** P700,000 target close
- **Impact:** Without funding, runway limited to 13 months; Rent2Buy pilot delayed
...
- **Action:** Automated email/SMS campaign; P50 credit incentive; target 80%+ completion by Q1 2026
- **Responsible:** Product Manager + CTO + Marketing Lead

### ✅ WINS & RESOLVED RISKS

**Intellectual Property Protection - RESOLVED**
- ✓ Trademark APPROVED by CIPA (Companies and Intellectual Property Authority)
- ✓ International trademark registration IN PROGRESS
- Filed through BDIH support

**Insurance & Liability Coverage - MITIGATED**
- ✓ Pay-U comprehensive insurance ACTIVE
- ✓ BIC partnership confirmed
- ✓ Bryte dispute resolution protocol in place
...
### Product 1: P2P Car Sharing (Current)
- **Model:** 15% commission
- **Insurance:** Pay-U comprehensive
- **Features:** 5-30 min confirmation, delivery/collection
...
- **Model:** Refleet partnership (used inventory)
- **Goal:** 3-5 dealerships by Q2 2026
...
**Next Milestones:**
- **Dec 15, 2025:** Close P700K pre-seed round (CRITICAL DEADLINE)
- **Q1 2026:** 
  - Drive user verification from 5% to 80%+ completion
  - Diversify fleet partners - reduce Trillo from 80% to <40%
  - Rent2Buy pilot (3 vehicles, 10 motshelo MOUs)
- **Q2 2026:** Public Rent2Buy launch
- **Q3 2026:** EV phase preparation

**Document Owner:** MobiRides Leadership Team  
